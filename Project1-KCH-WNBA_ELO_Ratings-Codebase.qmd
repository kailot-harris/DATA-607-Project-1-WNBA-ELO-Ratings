...
full_elo_df <- full_elo_df |>
  group_by(home_team_display_name) |>
  arrange(game_date) |>
  mutate(total_home_wins = sum(home_win),
         total_home_games = n(),
         total_home_losses = total_home_games - total_home_wins
  )
...
full_elo_df <- full_elo_df |>
  ungroup() |>
  group_by(away_team_display_name) |>
  arrange(game_date) |>
  mutate(total_away_losses = sum(home_win),
         total_away_games = n(),
         total_away_wins = total_away_games - total_away_losses,
